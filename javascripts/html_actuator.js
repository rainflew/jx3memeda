...
HTMLActuator.prototype.message = function (won) {
  ...
  mytxt[6]="你被集火了……谁让你是祭司来着……";
  mytxt[7]="你都混到苏大胸面前了还是被摁死了呢~";
  mytxt[8]="虽然巫医挺难听的不过同样是苏大胸面前已经很不错了！";
  mytxt[9]="作为每次都被留下一条性命卡小怪的刀锋同学你真是很有存在感~";
  mytxt[10]="啧！你没拿火把/没掐蝴蝶/没领迷香被大唐侠士识破了(丿_-;)";
  mytxt[11]="精英要干什么？大概就是在关键时刻拿着所有的酒掉线吧……";
  mytxt[12]="无CD大扇子随便跳，一边跳一边还要砍人的舞者说的就是你→_→";
  mytxt[13]="还差一步就可以取缔现任头子一拖九了，可惜哇！";
